        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoneQuantity = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaborCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GemSellPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GemType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StoneQuantity = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GoldSellPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GoldWeight = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ha Noi", "NGUYENVANA", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, "Nguyen Van A", null, "0123456789", 0, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 2, "Ha Noi", "NGUYENVANB", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, "Nguyen Van B", null, "0123456789", 0, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 3, "Ha Noi", "NGUYENVANC", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, "Nguyen Van C", null, "0123456789", 0, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 300m, "Ha Noi", new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6390), new TimeSpan(0, 7, 0, 0, 0)), 400m, "Ruby" },
                    { 2, 400m, "Ha Noi", new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6398), new TimeSpan(0, 7, 0, 0, 0)), 500m, "Sapphire" },
                    { 3, 500m, "Ha Noi", new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6400), new TimeSpan(0, 7, 0, 0, 0)), 600m, "Emerald" },
                    { 4, 500m, "Ha Noi", new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6402), new TimeSpan(0, 7, 0, 0, 0)), 600m, "Tektite" },
                    { 5, 500m, "Ha Noi", new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6404), new TimeSpan(0, 7, 0, 0, 0)), 600m, "Peridot" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000m, "Ha Noi", null, new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6425), new TimeSpan(0, 7, 0, 0, 0)), 1200m, "9999" },
                    { 2, 1200m, "Ha Noi", null, new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6428), new TimeSpan(0, 7, 0, 0, 0)), 1400m, "SCJ" },
                    { 3, 1400m, "Ha Noi", null, new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6430), new TimeSpan(0, 7, 0, 0, 0)), 1600m, "18k" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Giảm giá 10%", 1m, new DateTimeOffset(new DateTime(2024, 8, 7, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6336), new TimeSpan(0, 7, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6285), new TimeSpan(0, 7, 0, 0, 0)), "Giảm giá" },
                    { 2, null, "Giảm giá 20%", 2m, new DateTimeOffset(new DateTime(2024, 8, 7, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6350), new TimeSpan(0, 7, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6349), new TimeSpan(0, 7, 0, 0, 0)), "Giảm giá" },
                    { 3, null, "Giảm giá 30%", 3m, new DateTimeOffset(new DateTime(2024, 8, 7, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6353), new TimeSpan(0, 7, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 7, 28, 20, 42, 43, 833, DateTimeKind.Unspecified).AddTicks(6352), new TimeSpan(0, 7, 0, 0, 0)), "Giảm giá" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ADMIN", null, null, "admin@gmail.com", "ADMIN", "Male", "12345678", null, 1, false, null },
                    { 2, "USER", null, null, "user@gmail.com", "USER", null, "12345678", null, 2, false, null }
                });

            migrationBuilder.InsertData(
                table: "Jewelries",
                columns: new[] { "JewelryId", "Barcode", "Code", "CreatedAt", "IsSold", "JewelryTypeId", "LaborCost", "Name", "PreviewImage", "Type", "UpdatedAt", "WarrantyTime" },
                values: new object[,]
                {
                    { 1, "AVC131", null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), true, 1, 213m, "Vòng tay", null, 1, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null },
                    { 2, "SAC132", null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), false, 2, 231m, "Nhẫn", null, 1, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Code", "CounterId", "CreatedAt", "Email", "FullName", "Gender", "Password", "PhoneNumber", "RoleId", "Status", "UpdatedAt" },
                values: new object[] { 3, "STAFF", 3, null, "staff@gmail.com", "STAFF", null, "12345678", null, 3, false, null });
